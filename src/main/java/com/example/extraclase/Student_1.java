...
public class Student_1 extends Student {
    private float nota_promedio_ex_qu_ta;
    public Student_1(String carne, String nombre_apellido, String correo, int numero, String nickname, String tipo_student,
        ...
        this.nota_promedio_ex_qu_ta=calc_nota_promedio();
    }
    @Override
    ...
    public float calc_nota_promedio() {
        nota_promedio_ex_qu_ta=(getNota_promedio_examenes()+getNota_promedio_quices()+getNota_promedio_tareas())/3;
        return nota_promedio_ex_qu_ta;
    }
